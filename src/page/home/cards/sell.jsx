...
import {
    ...
    CardSalesCalculatorBalanceButtonText
} from "./components";
...
const Sell = ({ redirect }) => {
    ...
    const [calcRateValue, setCalcRateValue] = useState(0.00);
    ...
    function handleTextChange(e) {
        ...
        if (name === 'howmany') setHowMany(value);
    }
    ...
    console.log(selectedCardType, selectedCurrency, openSelectCurrency)
                            ...
                            <ContentsHolder>
                                ...
                                <CurrencySelect>
                                    <CurrencySelectButton onClick={handleOpenSelect}>
                                        <span style={{ pointerEvents: 'none' }}>{selectedCurrency || 'Select Currency'}</span>
                                            ...
                                            <>
                                                ...
                                                <CardSalesCalculator>
                                                    ...
                                                    <CardSalesCalculatorBalanceWrapper>
                                                        <CardSalesCalculatorBalanceText>NGN&nbsp;{calcRateValue}</CardSalesCalculatorBalanceText>
                                                    </CardSalesCalculatorBalanceWrapper>
                                                </CardSalesCalculator>
