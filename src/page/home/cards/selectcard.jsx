...
import {
    MobileAppBar, MobileHeader, MobileHeaderImage, MobileHeaderTextWrapper, MobileHeaderTextInnerWrapper, MobileHeaderBackButtonWrapper,
    MobileHeaderBackButtonInnerWrapper, MobileHeaderText, MobileHeaderInputWrapper, MobileHeaderInputImage, MobileHeaderInput, CardsWrapper,
    CardsInnerWrapper, CardItermWrapper, CardItermInnerWrapper, CardItermContentWrapper, CardItermContentText, CardItermContentImage,
    SecurityBtnBody, DesktopViewWrapper
} from "./components"

const SelectCard = ({ redirect }) => {
                    ...
                    <MobileHeaderTextWrapper>
                        <MobileHeaderTextInnerWrapper>
                            <MobileHeaderBackButtonWrapper>
                                <MobileHeaderBackButtonInnerWrapper onClick={() => redirect('/trade-cards')}>
