import {
    ...
    QuickActionsWrapper, QuickActionsText, QuickActionsWrap, QuickActionsSubText, DesktopSubHeaderContentWrapper, DesktopSubHeaderContentLeft, DesktopSubHeaderContentRight, DesktopSubHeaderContentTextWrapper, DesktopSubHeaderWalletTypeText, DesktopWithdrawBtn, DesktopWithdrawBtnText, DesktopProfileContentWrapper, DesktopProfileContentWrap, DesktopProfileTextContentWrap, DesktopQuickActionLine, DesktopQuickActionsWrapper, DesktopQuickActionsWrap, DesktopQuickActionContentWrapper, DesktopQuickActionContentLeftWrap, DesktopQuickActionContentRightWrap, PayBillTextWrapper, PayBillText, PayBillSubText,
                    ...
                    <MobileContent>
                        <HeaderContentWrapper>
                            <HeaderTextWrapper>
                                ...
                                <HeaderUserText>axus</HeaderUserText>
                            </HeaderTextWrapper>
                                    ...
                                    <WithdrawBtnWrapper>
                                        <WithdrawBtn>
                                            ...
                                            <WithdrawBtnTextWrapper>
                                                <WithdrawBtnText>Withdraw</WithdrawBtnText>
                                            </WithdrawBtnTextWrapper>
                                        </WithdrawBtn>
                                    </WithdrawBtnWrapper>
                                </SubHeaderTextWrapper>
            ...
            <DesktopContentWrapper sx={{ display: { md: 'none', lg: 'flex', xl: 'flex', xs: 'none', sm: 'none' } }}>
                <DesktopContentWrap>
                    <DesktopContent>
                        ...
                        <HeaderContentWrapper>
                            <HeaderTextWrapper>
                                <HeaderText>Hello, <span style={{ color: '#7165E3' }}>axus</span></HeaderText>
                            </HeaderTextWrapper>
                            <HeaderNotificationWrapper>
                                <HeaderNotificationIconWrap>
                                    <HeaderNotificationIconImage src="/svg/notification.svg" />
                        ...
                        <DesktopSubHeaderContentWrapper>
                            <DesktopSubHeaderContentLeft>
                                ...
                                <DesktopSubHeaderContentTextWrapper>
                                    ...
                                    <BalanceText>0.00<span style={{ fontSize: '1.5rem', fontFamily: "CeraPro-Medium, -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'", verticalAlign: 'top' }}>NGN</span></BalanceText>
                                    <DesktopWithdrawBtn>
                                        ...
                                        <DesktopWithdrawBtnText>Withdraw</DesktopWithdrawBtnText>
                                    </DesktopWithdrawBtn>
                                </DesktopSubHeaderContentTextWrapper>
                            </DesktopSubHeaderContentLeft>
