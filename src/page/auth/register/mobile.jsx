        ...
        <MobileAppBar container sx={{ display: { xs: 'flex', md: 'none' } }}>
            ...
            <FormWraper container xs={12}>
                <Grid xs={12} height={'50vh'}>
                    <InputsWrap>
                        <FormTittle>Create Account</FormTittle>                        
                        <MobileInputWrapper>
                    ...
                    <FooterWrapper>
                        <SubmitBtn>
                            ...
                            <SubmitBtnText>Create Account</SubmitBtnText>
                        </SubmitBtn>
                        <FooterText color="black">Already have an account? <FooterBtn>Login</FooterBtn></FooterText>
                    </FooterWrapper>
                </Grid>
            </FormWraper>
